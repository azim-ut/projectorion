...
import nuxt_plugin_plugin_4dc10efd from 'nuxt_plugin_plugin_4dc10efd' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_872cd662 from 'nuxt_plugin_bootstrapvue_872cd662' // Source: .\\bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_3dc156a0 from 'nuxt_plugin_axios_3dc156a0' // Source: .\\axios.js (mode: 'all')
import nuxt_plugin_fontawesome_7d03b1e2 from 'nuxt_plugin_fontawesome_7d03b1e2' // Source: .\\fontawesome.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"itp","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"```bash\r # install dependencies\r $ npm install"}],"script":[{"src":"..\u002F..\u002Fassets\u002Fjs\u002Fmaterialize.min.js"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[]},
  ...
  if (typeof nuxt_plugin_plugin_4dc10efd === 'function') {
    await nuxt_plugin_plugin_4dc10efd(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_872cd662 === 'function') {
    await nuxt_plugin_bootstrapvue_872cd662(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_3dc156a0 === 'function') {
    await nuxt_plugin_axios_3dc156a0(app.context, inject)
  }

  if (typeof nuxt_plugin_fontawesome_7d03b1e2 === 'function') {
    await nuxt_plugin_fontawesome_7d03b1e2(app.context, inject)
  }
